...
(async () => {
  ...
  const meta = { sourceId, chatId, appVersion: '5.0', userAgent: 'Mozilla/5.0', timeZone: 'Europe/Paris', language: 'fr', userId: nanoid(24), platform: 'Linux' };
  ...
  console.log('FIREBASE', fb.status);
